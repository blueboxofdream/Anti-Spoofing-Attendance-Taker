...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Attendance Taker", (20, 40), self.font, 1, (255, 255, 255), 1, cv2.LINE_AA)
...
def main():
    ...
    # Execute liveness_detection.py after attendance_taker.py exits
    subprocess.Popen(["python", "liveness_detection.py"])
